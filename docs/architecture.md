...
- `/api/taste-summary` receives the user's profile metrics and returns an AI-generated taste summary.
...
- Top genres and unique genre count summarize genres from the user's top artists.

## Recommendation System

- The frontend builds recommendation seeds from overlapping artists, repeated artists, and top artists.
- The backend builds a Gemini prompt using top artists, top tracks, recommendation seeds, artist frequency, taste shift, genres, and other profile metrics.
...
- Gemini is used for taste summaries and recommended artist generation.
